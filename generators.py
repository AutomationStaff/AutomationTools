...
class CreateRim(bpy.types.Operator):
    ...
    bl_description = "Automation Tools Rim Creator"
    ...
    def draw(self, context):
        ...
        col.prop(self, "wire")
        col.prop(self, "array_visibility")
        col.prop(self, "mirror_visibility")
        col.prop(self, "array_elements")
        col.prop(self, "subs")
        col.prop(self, "spoke")
        col.prop(self, "rim_depth")
        col.prop(self, "thick")
        col.prop(self, "cap_size")
        col.prop(self, "cap_protrusion")
        col.prop(self, "lugs")
        if self.lugs:
            col.prop(self, "lugs_num")
            col.prop(self, "lug_rot")
            col.prop(self, "lug_spin")
            col.prop(self, "lug_span")
        col.prop(self, "view_colors")
        col.prop(self, "new_collection")
        col.prop(self, "add_template")
...
class AddBevelWidthDriver(bpy.types.Operator):
...
class BevelWidthLerpInputBar(bpy.types.Operator):
    ...
    @classmethod
    def poll(cls, context):
        return context.object is not None and len(
            context.object.modifiers) > 0 and 'Bevel' in context.object.modifiers and len(
            context.object.animation_data.drivers) > 0
